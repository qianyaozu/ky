...
type WorkPlace struct {
	ID        bson.ObjectId `bson:"_id"` //工作面编号（主键）
	Name      string                     //工作面名称
...
type Drilling struct {
	ID              bson.ObjectId `bson:"_id"` //钻孔编号（主键）
	Name            string                     //钻孔名称
...
//顶底板位移
type Drift struct{
	ID              bson.ObjectId `bson:"_id"` //顶底板位移编号
	Name string  //顶底板名称
	InstallPosition string  //安装位置
...
type Displace struct {
	ID              bson.ObjectId `bson:"_id"` //离层编号
	InstallPosition string                     //安装位置
...
//倾角
type Dip struct{
	ID              bson.ObjectId `bson:"_id"` //倾角编号
	FrameID  string //支架编号
	InstallPosition string //安装位置
}
...
//支架
type Frame struct{
	ID              bson.ObjectId `bson:"_id"` //支架编号
...
//支柱
type Pillar struct{
	ID    bson.ObjectId `bson:"_id"` //支柱编号
	PillarNo int  //支柱编号
...
//基点
type Point struct{
	ID    bson.ObjectId `bson:"_id"` //基点编号
	Name string //基点名称
